    ...
    <div class="container">
        <div class="inner-wrap">
            <div class="header-left">
                            ...
                            @foreach ($categories as $category)
                                <li>
                                    <a href="javascript:void(0)">
                                        <i class="w-icon-lock"></i>{{ $category->category_name }}
                                    </a>
                                    <ul class="megamenu">
                                        <li>
                                            ...
                                            <ul>
                                                @foreach ($subcategories as $subcategory)
                                                    @if ($subcategory->category_name == $category->category_name)
                                                        <li><a href="{{ route('collection') }}">{{ $subcategory->subcategory_name }}</a>
                                                        </li>
                                                    @endif
                                                @endforeach
                                            </ul>
                                        ...
                                        <div class="banner-fixed menu-banner menu-banner2">
                                            <figure>
                                                <img src="{{asset('public/frontend/assets/images/menu/banner-2.jpg')}}" alt="Menu Banner"
                            ...
                            {{-- <li>
                                ...
                                <ul class="megamenu">
                                    <li>
                                        ...
                                        <hr class="divider">
                                        <ul>
                                            <li><a href="{{route('collection')}}">New Arrivals</a>
                                            </li>
                                            <li><a href="shop-fullwidth-banner.html">Best Sellers</a>
                                            </li>
                                            <li><a href="shop-fullwidth-banner.html">Trending</a></li>
                                ...
                                <ul class="megamenu">
                                    ...
                                    <li>
                                        <div class="menu-banner banner-fixed menu-banner3">
                                            <figure>
                                                <img src="{{asset('public/frontend/assets/images/menu/banner-3.jpg')}}" alt="Menu Banner"
                                ...
                                <ul class="megamenu">
                                    ...
                                    <li>
                                        <div class="menu-banner banner-fixed menu-banner4">
                                            <figure>
                                                <img src="{{asset('public/frontend/assets/images/menu/banner-4.jpg')}}" alt="Menu Banner"
                                    ...
                                    <li class="row">
                                        <div class="col-6">
                                            <div class="banner banner-fixed menu-banner5 br-xs">
                                                <figure>
                                                    <img src="{{asset('public/frontend/assets/images/menu/banner-5.jpg')}}" alt="Banner"
                                        ...
                                        <div class="col-6">
                                            <div class="banner banner-fixed menu-banner5 br-xs">
                                                <figure>
                                                    <img src="{{asset('public/frontend/assets/images/menu/banner-6.jpg')}}" alt="Banner"
                                                        width="410" height="123"
                ...
                <nav class="main-nav">
                    <ul class="menu active-underline">
                        ...
                        <li>
                            <a href="about-us.html">Insights</a>
                            <ul>
            ...
            <div class="header-right">
                <a href="#" class="d-xl-show"><i class="w-icon-map-marker mr-1"></i>Login</a>
                <a href="#"><i class="w-icon-sale"></i>Signup</a>
            </div>
        </div>
    </div>
</div>
